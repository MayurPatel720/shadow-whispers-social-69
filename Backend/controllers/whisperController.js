...
// @desc    Edit a single whisper message (only by sender)
// @route   PUT /api/whispers/message/:messageId
// @access  Private
...
// @desc    Delete a single whisper message (only by sender)
// @route   DELETE /api/whispers/message/:messageId
// @access  Private
