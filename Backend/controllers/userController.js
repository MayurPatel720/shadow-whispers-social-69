...
// (reuse your mail config, or set real SMTP creds for production)
...
const registerUser = asyncHandler(async (req, res) => {
  ...
  if (user) {
    ...
    user.emailVerificationExpires = Date.now() + 15 * 60 * 1000; // valid for 15 minutes
...
const verifyOtp = asyncHandler(async (req, res) => {
  ...
  if (
    ...
    res.status(400);
    throw new Error("OTP expired or request new code");
  }
